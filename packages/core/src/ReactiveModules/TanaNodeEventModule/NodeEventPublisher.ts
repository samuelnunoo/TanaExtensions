...
import TanaNodeEventModule from './index';
import {NodeViewType} from "../TanaNodeViewModule/types/configs/NodeViewType";
...
export default class NodeEventPublisher extends TanaPublisher<TanaNodeEventModule> {
